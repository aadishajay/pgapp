...
truncate table nexus_erp_accounts, nexus_erp_contacts, nexus_erp_leads, nexus_erp_opportunities, nexus_erp_activities, nexus_erp_quotes, nexus_erp_sales_orders, nexus_erp_invoices, nexus_erp_payments, nexus_erp_price_lists, nexus_erp_products, nexus_erp_categories, nexus_erp_warehouses, nexus_erp_stock_levels, nexus_erp_stock_movements, nexus_erp_suppliers, nexus_erp_purchase_orders, nexus_erp_purchase_order_lines, nexus_erp_goods_receipts, nexus_erp_supplier_invoices, nexus_erp_employees, nexus_erp_departments, nexus_erp_positions, nexus_erp_leave_requests, nexus_erp_attendance, nexus_erp_ledger_accounts, nexus_erp_expenses, nexus_erp_budgets, nexus_erp_ar_invoices, nexus_erp_ap_bills, nexus_erp_projects, nexus_erp_tasks, nexus_erp_milestones, nexus_erp_timesheets, nexus_erp_project_risks, nexus_erp_tickets, nexus_erp_agents, nexus_erp_knowledge_articles, nexus_erp_slas, nexus_erp_escalations, nexus_erp_campaigns, nexus_erp_marketing_leads, nexus_erp_email_templates, nexus_erp_segments, nexus_erp_events, nexus_erp_work_orders, nexus_erp_boms, nexus_erp_machines, nexus_erp_maintenance_logs, nexus_erp_quality_checks, nexus_erp_assets, nexus_erp_locations, nexus_erp_contracts, nexus_erp_maintenance_requests, nexus_erp_reservations, nexus_erp_policies, nexus_erp_audit_logs, nexus_erp_approvals, nexus_erp_notifications, nexus_erp_documents restart identity cascade;

-- Accounts (30000 rows — hot table)
insert into nexus_erp_accounts (company_name, status, annual_revenue, is_active, notes, created_at)
select
...
-- Leads (2000 rows)
insert into nexus_erp_leads (lead_name, status, estimated_value, is_hot, notes, created_at)
select
...
insert into nexus_erp_opportunities (opportunity_name, status, deal_value, is_priority, notes, created_at)
select
...
insert into nexus_erp_activities (subject, status, duration_minutes, is_billable, notes, created_at)
select
...
-- Quotes (2000 rows)
insert into nexus_erp_quotes (quote_number, status, quote_total, is_expired, notes, created_at)
select
...
-- Invoices (2000 rows)
insert into nexus_erp_invoices (invoice_number, status, amount_due, is_recurring, notes, created_at)
select
...
-- Payments (2000 rows)
insert into nexus_erp_payments (payment_reference, status, payment_amount, is_partial, notes, created_at)
select
...
insert into nexus_erp_price_lists (price_list_name, status, discount_percent, is_default, notes, created_at)
select
...
insert into nexus_erp_products (product_name, status, unit_price, is_taxable, notes, created_at)
select
...
insert into nexus_erp_categories (category_name, status, sort_order, is_featured, notes, created_at)
select
...
insert into nexus_erp_warehouses (warehouse_name, status, capacity_units, is_primary, notes, created_at)
select
...
insert into nexus_erp_stock_movements (movement_reference, status, quantity_moved, is_approved, notes, created_at)
select
...
-- Suppliers (2000 rows)
insert into nexus_erp_suppliers (supplier_name, status, rating_score, is_preferred, notes, created_at)
select
...
-- PO lines (2000 rows)
insert into nexus_erp_purchase_order_lines (line_reference, status, line_quantity, is_backordered, notes, created_at)
select
...
insert into nexus_erp_goods_receipts (receipt_number, status, received_quantity, has_discrepancy, notes, created_at)
select
...
insert into nexus_erp_supplier_invoices (invoice_reference, status, invoice_amount, is_overdue, notes, created_at)
select
...
insert into nexus_erp_employees (full_name, status, annual_salary, is_manager, notes, created_at)
select
...
insert into nexus_erp_departments (department_name, status, headcount, is_cost_center, notes, created_at)
select
...
insert into nexus_erp_leave_requests (request_reference, status, days_requested, is_emergency, notes, created_at)
select
...
insert into nexus_erp_attendance (attendance_reference, status, hours_worked, is_overtime, notes, created_at)
select
...
insert into nexus_erp_ledger_accounts (account_name, status, current_balance, is_reconciled, notes, created_at)
select
...
-- Expenses (2000 rows)
insert into nexus_erp_expenses (expense_reference, status, expense_amount, is_billable, notes, created_at)
select
...
-- Budgets (2000 rows)
insert into nexus_erp_budgets (budget_name, status, budget_amount, is_locked, notes, created_at)
select
...
-- AP bills (2000 rows)
insert into nexus_erp_ap_bills (bill_number, status, bill_amount, is_recurring, notes, created_at)
select
...
insert into nexus_erp_projects (project_name, status, budget_allocated, is_at_risk, notes, created_at)
select
...
insert into nexus_erp_milestones (milestone_name, status, completion_percent, is_critical, notes, created_at)
select
...
insert into nexus_erp_timesheets (timesheet_reference, status, hours_logged, is_overtime, notes, created_at)
select
...
insert into nexus_erp_project_risks (risk_name, status, impact_score, is_high_priority, notes, created_at)
select
...
insert into nexus_erp_tickets (subject, status, satisfaction_score, is_urgent, notes, created_at)
select
...
-- Agents (2000 rows)
insert into nexus_erp_agents (agent_name, status, tickets_closed, is_lead, notes, created_at)
select
...
insert into nexus_erp_knowledge_articles (article_title, status, view_count, is_featured, notes, created_at)
select
...
-- SLAs (2000 rows)
insert into nexus_erp_slas (sla_name, status, response_minutes, is_critical, notes, created_at)
select
...
-- Campaigns (2000 rows)
insert into nexus_erp_campaigns (campaign_name, status, budget_spent, is_paid, notes, created_at)
select
...
insert into nexus_erp_email_templates (template_name, status, open_rate_percent, is_default, notes, created_at)
select
  (array['Atlas','Nova','Zenith','Orion','Vertex','Summit','Beacon','Cobalt','Delta','Ember','Falcon','Granite','Harbor','Indigo','Juniper','Keystone','Lumen','Meridian','Nimbus','Onyx','Pinnacle','Quartz','Ridge','Solstice','Talon','Umbra','Vantage','Willow','Xenon','Yield','Zephyr'])[1 + floor(random()*31)::int] || ' ' || (array['Atlas','Nova','Zenith','Orion','Vertex','Summit','Beacon','Cobalt','Delta','Ember','Falcon','Granite','Harbor','Indigo','Juniper','Keystone','Lumen','Meridian','Nimbus','Onyx','Pinnacle','Quartz','Ridge','Solstice','Talon','Umbra','Vantage','Willow','Xenon','Yield','Zephyr'])[1 + floor(random()*31)::int] || ' Email template ' || g::text,
...
-- Segments (2000 rows)
insert into nexus_erp_segments (segment_name, status, audience_size, is_dynamic, notes, created_at)
select
...
-- Events (2000 rows)
insert into nexus_erp_events (event_name, status, attendee_count, is_virtual, notes, created_at)
select
...
insert into nexus_erp_work_orders (work_order_number, status, estimated_hours, is_priority, notes, created_at)
select
...
-- BOMs (2000 rows)
insert into nexus_erp_boms (bom_name, status, component_count, is_active, notes, created_at)
select
...
-- Machines (2000 rows)
insert into nexus_erp_machines (machine_name, status, uptime_percent, needs_service, notes, created_at)
select
...
insert into nexus_erp_quality_checks (check_reference, status, defect_count, requires_rework, notes, created_at)
select
...
-- Assets (2000 rows)
insert into nexus_erp_assets (asset_name, status, asset_value, is_leased, notes, created_at)
select
...
-- Locations (2000 rows)
insert into nexus_erp_locations (location_name, status, square_footage, is_headquarters, notes, created_at)
select
...
insert into nexus_erp_maintenance_requests (request_reference, status, priority_level, is_urgent, notes, created_at)
select
...
insert into nexus_erp_reservations (reservation_reference, status, attendee_count, is_recurring, notes, created_at)
select
...
-- Policies (2000 rows)
insert into nexus_erp_policies (policy_name, status, version_number, is_mandatory, notes, created_at)
select
...
insert into nexus_erp_audit_logs (audit_reference, status, finding_count, is_high_risk, notes, created_at)
select
...
-- Approvals (2000 rows)
insert into nexus_erp_approvals (approval_reference, status, approval_level, is_escalated, notes, created_at)
select
...
insert into nexus_erp_notifications (notification_title, status, priority_score, is_broadcast, notes, created_at)
select
...
with pool_contacts as (
  select array_agg(company_name) as vals, count(*) as n from nexus_erp_accounts
)
insert into nexus_erp_contacts (full_name, status, is_primary, account_name, notes, created_at)
select
...
with pool_sales_orders as (
  select array_agg(quote_number) as vals, count(*) as n from nexus_erp_quotes
)
insert into nexus_erp_sales_orders (order_number, status, order_total, is_rush, linked_quote, notes, created_at)
select
...
with pool_stock_levels as (
  select array_agg(product_name) as vals, count(*) as n from nexus_erp_products
)
insert into nexus_erp_stock_levels (sku, status, quantity_on_hand, needs_reorder, product_name, notes, created_at)
select
...
with pool_purchase_orders as (
  select array_agg(supplier_name) as vals, count(*) as n from nexus_erp_suppliers
)
insert into nexus_erp_purchase_orders (po_number, status, po_total, is_urgent, supplier_name, notes, created_at)
select
...
with pool_positions as (
  select array_agg(department_name) as vals, count(*) as n from nexus_erp_departments
)
insert into nexus_erp_positions (title, status, pay_grade, is_remote, department_name, notes, created_at)
select
...
with pool_ar_invoices as (
  select array_agg(account_name) as vals, count(*) as n from nexus_erp_ledger_accounts
)
insert into nexus_erp_ar_invoices (invoice_number, status, outstanding_amount, is_disputed, linked_account, notes, created_at)
select
...
-- Tasks (2000 rows)
with pool_tasks as (
  select array_agg(project_name) as vals, count(*) as n from nexus_erp_projects
)
insert into nexus_erp_tasks (task_name, status, estimated_hours, is_blocked, project_name, notes, created_at)
select
...
with pool_escalations as (
  select array_agg(subject) as vals, count(*) as n from nexus_erp_tickets
)
insert into nexus_erp_escalations (escalation_reference, status, severity_level, is_customer_facing, escalated_ticket, notes, created_at)
select
...
with pool_marketing_leads as (
  select array_agg(campaign_name) as vals, count(*) as n from nexus_erp_campaigns
)
insert into nexus_erp_marketing_leads (lead_name, status, lead_score, is_mql, campaign_name, notes, created_at)
select
...
with pool_maintenance_logs as (
  select array_agg(machine_name) as vals, count(*) as n from nexus_erp_machines
)
insert into nexus_erp_maintenance_logs (log_reference, status, downtime_minutes, is_unplanned, machine_name, notes, created_at)
select
...
with pool_contracts as (
  select array_agg(location_name) as vals, count(*) as n from nexus_erp_locations
)
insert into nexus_erp_contracts (contract_name, status, contract_value, is_auto_renew, location_name, notes, created_at)
select
...
with pool_documents as (
  select array_agg(policy_name) as vals, count(*) as n from nexus_erp_policies
)
insert into nexus_erp_documents (document_title, status, page_count, is_confidential, policy_name, notes, created_at)
select
