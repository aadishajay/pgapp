...
truncate showcase_products restart identity;
truncate showcase_tasks restart identity;
truncate showcase_cities restart identity;
truncate showcase_feedback restart identity;
truncate showcase_team_members restart identity;

insert into showcase_products (name, category, price, rating, featured, in_stock, description) values
...
insert into showcase_tasks (title, status, priority, due_date, urgent, assignee, tags, notes) values
...
insert into showcase_cities (name, country, lat, lng, population) values
...
insert into showcase_feedback (name, email, topic, rating, comments) values
...
insert into showcase_team_members (name, role, department, color, bio, skills, active) values
