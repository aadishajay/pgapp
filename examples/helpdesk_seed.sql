-- Seed data for the Nova Helpdesk demo app.
truncate pgapp_data.helpdesk_tickets restart identity;
truncate pgapp_data.helpdesk_agents restart identity;

insert into pgapp_data.helpdesk_agents (name, team, active) values
...
insert into pgapp_data.helpdesk_tickets (subject, status, priority, agent, urgent, satisfaction, notes, created_at) values
